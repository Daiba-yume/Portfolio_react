...
const projects = [
  ...
  },
  {
    ...
    title: "p5",
    desc: "Cinquième projet : Développer un moteur de recherche performant pour un site de recettes en implémentant deux versions d'un algorithme boucles natives (if/while) et programmation fonctionnelle (some/filter), en comparant leurs performances et en respectant les bonnes pratiques de Green Code.",
    stack: [{ name: "Html 5" }, { name: "Css 3" }, { name: "JavaScript" }],
