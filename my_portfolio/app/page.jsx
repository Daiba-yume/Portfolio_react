          ...
          <div className="text-center xl:text-left order-2 xl:order-none">
            ...
            <p className="max-w-[900px] mb-9 text-white/80">
              <strong>
                ...
                projet est une nouvelle occasion d'apprendre et de m'améliorer.
              </strong>
            </p>
            {/* btn and socials */}
            <div className="flex flex-col xl:flex-row items-center gap-10">
              ...
              <div className="mb-8 xl:mb-0">
                <Socials
                  ...
                  iconStyles="w-12 h-12  border boder-accent rounded-full flex justify-center items-center text-accent tex-base hover:bg-accent hover:text-primary hover:transition-all duration-500"
                />
              </div>
            </div>
          </div>
